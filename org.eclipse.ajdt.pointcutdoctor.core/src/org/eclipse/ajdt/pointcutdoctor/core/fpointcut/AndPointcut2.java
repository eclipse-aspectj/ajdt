...
//TODO this class is a hack because left and right in AndPointcut/OrPointcut are not accesible.
public class AndPointcut2 extends AndPointcut {

	private Pointcut left2;
	private Pointcut right2;

	public AndPointcut2(Pointcut left, Pointcut right) {
		super(left, right);
		this.left2 = left;
		this.right2 = right;
	}
