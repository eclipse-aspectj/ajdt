...
public class ReturnTypeRelaxer extends SignatureRelaxer {
	...
	protected void doRelax(World world, List<RelaxData> results) {
		...
		if (affectingPointcut instanceof KindedPointcut) {
			...
			if (sig.getReturnType()!=TypePattern.ANY) {
				results.add(new RelaxData(RelaxOp.Replace, TypePattern.ANY, this, affectingPointcut));
			}
		}
	}
