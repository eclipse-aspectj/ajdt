 ...
 * visualiser drawing style. This is the default renderer. Custom renderers can
 * either implement the interface directly or extend this class.
 * 
 * @author mchapman
 */
public class DefaultVisualiserRenderer implements IVisualiserRenderer {
	...
	public int getColumnHeaderHeight() {
		if (columnTitleHeight < 0) {
			...
			GC gc = new GC(tmpImg);
			gc.setFont(sysFont);
			String s = VisualiserPlugin.getResourceString("Visualiser.testString"); //$NON-NLS-1$
			// determine string height, and scale up a little to increase padding
