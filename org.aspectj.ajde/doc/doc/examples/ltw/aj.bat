...
REM Created on Wed Oct 13 09:41:21 BST 2004 by AndyClement

if "%JAVA_HOME%" == "" set JAVA_HOME=C:\Program Files\Java\j2re1.4.2_03
if "%ASPECTJ_HOME%" == "" set ASPECTJ_HOME=c:\aspectj1.2_formatt
