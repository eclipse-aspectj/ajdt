...
public class InternalExtendedCompletionContext {
	...
	private void computeEnclosingJavaElements() {
		...
		if (this.typeRoot.getElementType() == IJavaElement.COMPILATION_UNIT) {
	 		ICompilationUnit original = (org.aspectj.org.eclipse.jdt.core.ICompilationUnit)this.typeRoot;
			...
			org.aspectj.org.eclipse.jdt.core.ICompilationUnit handle = new AssistCompilationUnit(original, this.owner, handleToBinding, handleToInfo);
