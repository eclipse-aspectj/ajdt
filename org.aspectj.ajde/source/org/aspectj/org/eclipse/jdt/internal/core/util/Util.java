...
public class Util {
	...
	public static byte[] getResourceContentsAsByteArray(IFile file) throws JavaModelException {
		...
		try {
			return org.aspectj.org.eclipse.jdt.internal.compiler.util.Util.getInputStreamAsByteArray(stream);
		} catch (IOException e) {
	...
	public static char[] getResourceContentsAsCharArray(IFile file, String encoding) throws JavaModelException {
		...
		try {
			return org.aspectj.org.eclipse.jdt.internal.compiler.util.Util.getInputStreamAsCharArray(stream, encoding);
		} catch (IOException e) {
			throw new JavaModelException(e, IJavaModelStatusConstants.IO_EXCEPTION);
		} finally {
			try {
