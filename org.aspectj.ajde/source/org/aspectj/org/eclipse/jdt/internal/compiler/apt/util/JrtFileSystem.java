...
public class JrtFileSystem extends Archive {
	...
	class JrtFileObject extends ArchiveFileObject {
		...
		public CharSequence getCharContent(boolean ignoreEncodingErrors) throws IOException {
			try {
				return Util.getCharContents(this, ignoreEncodingErrors,
						org.aspectj.org.eclipse.jdt.internal.compiler.util.JRTUtil.getClassfileContent(this.file, this.entryName, new String(this.module.name())),
						this.charset.name());
			} catch (ClassFormatException e) {
				e.printStackTrace();
			}
		...
		public InputStream openInputStream() throws IOException {
			return org.aspectj.org.eclipse.jdt.internal.compiler.util.JRTUtil.getContentFromJrt(this.file, this.entryName, null);
		}
