...
private void buildForProject(JavaProject project, ArrayList potentialSubtypes, org.aspectj.org.eclipse.jdt.core.ICompilationUnit[] workingCopies, HashSet localTypes, IProgressMonitor monitor) throws JavaModelException {
	...
	if (openablesLength > 0) {
		...
		org.aspectj.org.eclipse.jdt.core.ICompilationUnit[] unitsToLookInside = null;
		if (inProjectOfFocusType) {
			org.aspectj.org.eclipse.jdt.core.ICompilationUnit unitToLookInside = focusType.getCompilationUnit();
...
private void buildFromPotentialSubtypes(String[] allPotentialSubTypes, HashSet localTypes, IProgressMonitor monitor) {
	...
	if (workingCopies != null && (wcLength = workingCopies.length) > 0) {
		...
		for (int i = 0; i < wcLength; i++) {
			org.aspectj.org.eclipse.jdt.core.ICompilationUnit workingCopy = workingCopies[i];
