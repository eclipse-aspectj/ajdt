...
public class BinaryType extends BinaryMember implements IType, SuffixConstants {
	...
	public static final JavadocContents EMPTY_JAVADOC = new JavadocContents(null, org.aspectj.org.eclipse.jdt.internal.compiler.util.Util.EMPTY_STRING);
...
public String getSuperclassTypeSignature() throws JavaModelException {
	...
	if (genericSignature != null) {
		...
		int start = index;
		index = org.aspectj.org.eclipse.jdt.internal.compiler.util.Util.scanClassTypeSignature(genericSignature, start) + 1;
...
public String[] getSuperInterfaceTypeSignatures() throws JavaModelException {
	...
	if (genericSignature != null) {
		...
		// skip superclass
		index = org.aspectj.org.eclipse.jdt.internal.compiler.util.Util.scanClassTypeSignature(genericSignature, index) + 1;
