...
import org.aspectj.org.eclipse.jdt.internal.core.nd.util.PathMap;
...
public class IndexBasedJavaSearchEnvironment implements INameEnvironment, SuffixConstants {
	...
	public IndexBasedJavaSearchEnvironment(List<IJavaProject> javaProject, org.aspectj.org.eclipse.jdt.core.ICompilationUnit[] copies) {
	...
	private NameEnvironmentAnswer findClassInUnindexedLocations(String qualifiedTypeName, char[] typeName) {
		...
		while (iter.hasNext()) {
			...
			if (location instanceof ClasspathSourceDirectory) {
				...
				org.aspectj.org.eclipse.jdt.internal.compiler.env.ICompilationUnit workingCopy = (org.aspectj.org.eclipse.jdt.internal.compiler.env.ICompilationUnit) this.workingCopies.get(qualifiedTypeName);
				if (workingCopy != null) {
	...
	public static INameEnvironment create(List<IJavaProject> javaProjects, org.aspectj.org.eclipse.jdt.core.ICompilationUnit[] copies) {
