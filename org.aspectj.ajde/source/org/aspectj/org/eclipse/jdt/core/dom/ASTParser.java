...
import org.aspectj.org.eclipse.jdt.internal.core.ClassFileWorkingCopy;
...
public class ASTParser {
				...
				if (this.rawSource == null) {
					if (this.typeRoot != null) {
						...
						if (this.typeRoot instanceof ICompilationUnit) {
							org.aspectj.org.eclipse.jdt.internal.compiler.env.ICompilationUnit sourceUnit = (org.aspectj.org.eclipse.jdt.internal.compiler.env.ICompilationUnit) this.typeRoot;
	...
	private ASTNode internalCreateASTForKind() {
		...
		switch(this.astKind) {
			...
			case K_CLASS_BODY_DECLARATIONS :
				final org.aspectj.org.eclipse.jdt.internal.compiler.ast.ASTNode[] nodes =
