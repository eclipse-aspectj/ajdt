...
public class PerformancePlugin extends AbstractUIPlugin {
	...
	public ResourceBundle getResourceBundle() {
		try {
			if (resourceBundle == null)
				resourceBundle = ResourceBundle.getBundle("org.eclipse.ajdt.tests.performance.PerformancePluginResources");
	...
	public static ImageDescriptor getImageDescriptor(String path) {
		return AbstractUIPlugin.imageDescriptorFromPlugin("org.eclipse.ajdt.tests.performance", path);
	}
}
