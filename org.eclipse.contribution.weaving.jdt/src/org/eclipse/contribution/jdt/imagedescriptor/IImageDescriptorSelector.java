...
public interface IImageDescriptorSelector {
     ...
     */
    ImageDescriptor getTypeImageDescriptor(boolean isInner, boolean isInInterfaceOrAnnotation, int flags, boolean useLightIcons, Object element);

    /**
     * Creates the image descriptor for Java-like elements appearing in content assist
     */
    ImageDescriptor createCompletionProposalImageDescriptor(LazyJavaCompletionProposal proposal);
}
