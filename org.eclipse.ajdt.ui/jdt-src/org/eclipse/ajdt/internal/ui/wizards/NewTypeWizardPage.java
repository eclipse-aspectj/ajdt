...
public abstract class NewTypeWizardPage extends NewContainerWizardPage {
	...
	protected void initTypePage(IJavaElement elem) {
		...
		if (selection != null) {
			...
			if (text != null && JavaConventions.validateJavaTypeName(text, CompilerOptions.VERSION_1_3,CompilerOptions.VERSION_1_3).isOK()) {
				typeName= text;
			}
		}
	...
	protected IStatus typeNameChanged() {
		...
		IStatus val= JavaConventions.validateJavaTypeName(typeName, CompilerOptions.VERSION_1_3,CompilerOptions.VERSION_1_3);
		if (val.getSeverity() == IStatus.ERROR) {
