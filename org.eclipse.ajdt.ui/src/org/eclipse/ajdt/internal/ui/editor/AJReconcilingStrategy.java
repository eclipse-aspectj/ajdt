...
// Copied from JavaReconcilingStrategy.  Changes marked // AspectJ Change.
public class AJReconcilingStrategy implements IReconcilingStrategy, IReconcilingStrategyExtension {
	...
	public AJReconcilingStrategy(ITextEditor editor) {
		fEditor= editor;
		// AspectJ Change begin - use the AJDT working copy manager
		fManager= AspectJUIPlugin.getDefault().getWorkingCopyManager();
		fDocumentProvider= AspectJUIPlugin.getDefault().getCompilationUnitDocumentProvider();
		// AspectJ Change end
