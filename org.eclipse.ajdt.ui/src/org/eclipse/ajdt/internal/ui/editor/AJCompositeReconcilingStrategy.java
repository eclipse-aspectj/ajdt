...
// Copied from JavaCompositeReconcilingStrategy - changed to use an AJReconcilingStrategy instead of a JavaReconcilingStrategy
public class AJCompositeReconcilingStrategy  extends JavaCompositeReconcilingStrategy {

	private ITextEditor fEditor;
	private AJReconcilingStrategy fJavaStrategy;
	 ...
	 */
	public AJCompositeReconcilingStrategy(ITextEditor editor, String documentPartitioning) {
		super(editor, documentPartitioning);
		fEditor= editor;
		fJavaStrategy= new AJReconcilingStrategy(editor);
