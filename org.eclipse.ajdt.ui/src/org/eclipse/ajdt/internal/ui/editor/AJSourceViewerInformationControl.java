...
/* copied from org.eclipse.jdt.internal.ui.text.java.hover.SourceViewerInformationControl
 ...
 * @since 3.0
 */
public class AJSourceViewerInformationControl implements IInformationControl, IInformationControlExtension, DisposeListener {
	 ...
	 */
	public AJSourceViewerInformationControl(Shell parent, int shellStyle, int style) {
	 ...
	 * @since 3.0
	 */
	public AJSourceViewerInformationControl(Shell parent, int shellStyle, int style, String statusFieldText) {
		GridLayout layout;
		GridData gd;
		...
		fViewer.configure(new SimpleJavaSourceViewerConfiguration(
				AspectJUIPlugin.getDefault().getAspectJTextTools()
						.getColorManager(), store, null, null, false) {
			protected RuleBasedScanner getCodeScanner() {
				return AspectJUIPlugin.getDefault().getAspectJTextTools()
						.getCodeScanner();
			}
		});
		// AspectJ change end
	 ...
	 * @param style the additional styles for the styled text widget
	 */
	public AJSourceViewerInformationControl(Shell parent,int style) {
	 ...
	 * @since 3.0
	 */
	public AJSourceViewerInformationControl(Shell parent,int style, String statusFieldText) {
	 ...
	 * @param parent the parent shell
	 */
	public AJSourceViewerInformationControl(Shell parent) {
	 ...
	 * @since 3.0
	 */
	public AJSourceViewerInformationControl(Shell parent, String statusFieldText) {
