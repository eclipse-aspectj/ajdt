 ...
 */
public class AJJarOptionsPage extends WizardPage implements IJarPackageWizardPage {
...
//			 AspectJ Change Begin
			if (fileExtension == null || !fileExtension.equals(AJJarPackagerUtil.DESCRIPTION_EXTENSION)) {
				setErrorMessage(Messages.format(JarPackagerMessages.JarOptionsPage_error_invalidDescriptionExtension, AJJarPackagerUtil.DESCRIPTION_EXTENSION)); //$NON-NLS-1$
//				 AspectJ Change End
				return false;
			}
		}
