...
public class LTWAspectPathTab extends JavaClasspathTab {
	...
	private static final String ERROR_MESSAGE = AspectJUIPlugin.getResourceString("LTWAspectPathTab_errormessage");
	...
	public void createControl(Composite parent) {
		...
		label.setText( AspectJUIPlugin.getResourceString("LTWAspectPathTab_label"));
	...
	public String getName() {
		return  AspectJUIPlugin.getResourceString("LTWAspectPathTab_title");
	}
