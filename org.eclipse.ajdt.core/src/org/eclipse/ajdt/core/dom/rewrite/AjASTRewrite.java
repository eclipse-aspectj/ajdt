...
public class AjASTRewrite {
	 ...
	 */
	public static AjASTRewrite create(AST ast) {
		// AspectJ Change begin
		//return new ASTRewrite(ast);
		return new AjASTRewrite(ast);
		// AspectJ Change End
	}
	 ...
	 */
	protected AjASTRewrite(AST ast) {
		this.ast= ast;
...
//	}
	...
	public TextEdit rewriteAST() throws JavaModelException, IllegalArgumentException {
		...
		Map<String, String> options= typeRoot.getJavaProject().getOptions(true);
	...
	*/
	 ...
	 * or if the described modification is invalid
	 */
	public final AjListRewrite /*ListRewrite*/ getListRewrite(ASTNode node, ChildListPropertyDescriptor property) {
		if (node == null || property == null) {
			throw new IllegalArgumentException();
		}
		...
		return new AjListRewrite(this, node, property);
		// AspectJ Change End
	}
