...
public final class AjListRewrite {
	...
	private final StructuralPropertyDescriptor childProperty;
	// AspectJ Change Begin
	//private ASTRewrite rewriter;
	private final AjASTRewrite rewriter;
	// AspectJ Change End

	/* package*/ AjListRewrite(AjASTRewrite rewriter, ASTNode parent, StructuralPropertyDescriptor childProperty) {
	 ...
	 * @since 3.1
	 */
	// AspectJ Change - return type was ASTRewrites
	public AjASTRewrite getASTRewrite() {
