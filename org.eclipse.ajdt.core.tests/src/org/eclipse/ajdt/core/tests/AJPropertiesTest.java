...
public class AJPropertiesTest extends AJDTCoreTestCase {
	...
	public void testGetAJPropertiesFiles() throws Exception {
		...
		List<IFile> props = AJProperties.getAJPropertiesFiles(project);
		assertEquals("Project should contain two .ajproperties files", 2, props.size()); //$NON-NLS-1$
		String name1 = (props.get(0)).getName();
		String name2 = (props.get(1)).getName();
