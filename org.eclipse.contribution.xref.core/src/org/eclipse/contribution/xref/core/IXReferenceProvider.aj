...
public interface IXReferenceProvider {
  ...
  Class<?>[] getClasses();
	 ...
	 */
  Collection<IXReference> getXReferences(Object o, List<String> l);

	IJavaElement[] getExtraChildren(IJavaElement je);
  ...
  String getProviderDescription();
	 ...
	 */
  void setCheckedFilters(List<String> l);
	 ...
	 */
  void setCheckedInplaceFilters(List<String> l);
  ...
  List<String> getFilterDefaultList();
	 ...
	 */
  // TODO:
  //   Inner classes of an interface are implicitly static. But AJC does not recognise that.
