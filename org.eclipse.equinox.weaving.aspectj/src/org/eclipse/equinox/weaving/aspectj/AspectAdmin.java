...
public interface AspectAdmin {
     ...
     * aspects.
     */
    String AOP_BUNDLE_FINISHED_HEADER = "Eclipse-AspectBundle"; //$NON-NLS-1$
     ...
     */
    String AOP_BUNDLE_FINISHED_VALUE = "finished"; //$NON-NLS-1$

    /**
     * This is the default value for the location of the aop.xml file inside a
     * bundle
     */
    String AOP_CONTEXT_DEFAULT_LOCATION = "META-INF/aop.xml"; //$NON-NLS-1$
     ...
     */
    Definition getAspectDefinition(final Bundle bundle);
     ...
     *         defailt case)
     */
    int getAspectPolicy(Bundle bundle, String packageName);
     ...
     *         visible
     */
    Definition getExportedAspectDefinitions(final Bundle bundle);
     ...
     *         package
     */
    Definition resolveImportedPackage(final Bundle bundle,
     ...
     *         bundle
     */
    Definition resolveRequiredBundle(final Bundle bundle,
