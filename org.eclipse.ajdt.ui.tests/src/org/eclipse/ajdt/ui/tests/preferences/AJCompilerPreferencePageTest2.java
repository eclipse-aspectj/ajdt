...
public class AJCompilerPreferencePageTest2 extends UITestCase {
	...
	/**
	 * Change to using project settings 1. Press "Apply" and "OK" to rebuild now
	 * ==> expect build 2. Press "OK" and "OK" to rebuild now ==> don't expect
	 * build
	 */
	...
	/**
	 * Change back to using workspace settings 1. Press "Apply" and "OK" to
	 * rebuild now ==> expect build 2. Press "OK" and "OK" to rebuild now ==>
	 * don't expect build
	 */
