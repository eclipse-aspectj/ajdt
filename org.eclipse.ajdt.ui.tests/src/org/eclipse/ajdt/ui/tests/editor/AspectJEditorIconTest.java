...
public class AspectJEditorIconTest extends UITestCase {
    ...
    assertEquals("Boundpoint.aj should have the plain editor image after a build", editor1.getTitleImage(), plainAJEditorImage); //$NON-NLS-1$
    assertEquals("Demo.java should have the error editor image after a build", editor2.getTitleImage(), errorAJEditorImage);			 //$NON-NLS-1$
    assertEquals("Point.java should have the warning editor image after a build", editor3.getTitleImage(), warningAJEditorImage); //$NON-NLS-1$
