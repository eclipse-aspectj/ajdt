 ...
 */
  ...
  /*
   * Introduce the property change registration methods into Point. also
   * introduce implementation of the Serializable interface.
   */
  ...
  /**
   * Pointcut describing the set <property>methods on Point. (uses a wildcard in
   * the method name)
   */
...
&& target(p);
  ...
  /**
   * Advice to get the property change event fired when the setters are called. It's around advice because you need the old value of the property.
   */
